# estimate temporal snr from timeseries
...
def tsnr(file, verbose=False, outfile_type=None, stepsize=50):
    """
...
if __name__ == "__main__":
    ...
    meanimgfile = imgmean(args.file, args.verbose, args.outfile_type)
    meanbrain = nib.load(meanimgfile).dataobj
    print(f'making std image for {args.file}')
